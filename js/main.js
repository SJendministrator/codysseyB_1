...
// ==============================
// Project Debug: console command → forced state render
// ==============================

window.portfolioDebug = {
    projects: {
        loading: () => renderProjects("loading"),
        error: () => renderProjects("error"),
        empty: () => renderProjects("success", []),
        success: () => renderProjects("success", [{
            name: "debug-project",
            description: "콘솔에서 성공 상태를 확인하기 위한 예시 프로젝트입니다.",
            language: "JavaScript",
            html_url: "https://github.com/SJendministrator",
            stargazers_count: 0
        }]),
